...
public class ActionBarView extends AbsActionBarView {
    ...
    private void initTitle() {
        if (mTitleLayout == null) {
            ...
            mTitleLayout = (LinearLayout) inflater.inflate(R.layout.abs__action_bar_title_item,
                    this, false);
            mTitleView = mTitleLayout.findViewById(R.id.abs__action_bar_title);
            mSubtitleView = mTitleLayout.findViewById(R.id.abs__action_bar_subtitle);
    ...
    public static class HomeView extends FrameLayout {
        ...
        protected void onFinishInflate() {
            ...
            mIconView = findViewById(R.id.abs__home);
        }
