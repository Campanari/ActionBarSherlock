...
//    });
    ...
    private final static class ChildViewCache {
        ...
        public ChildViewCache(View v) {
            mText1 = v.findViewById(android.R.id.text1);
            mText2 = v.findViewById(android.R.id.text2);
            mIcon1 = v.findViewById(android.R.id.icon1);
            mIcon2 = v.findViewById(android.R.id.icon2);
            mIconRefine = v.findViewById(R.id.edit_query);
        }
    }
