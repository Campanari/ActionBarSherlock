...
public class ActionBarSherlockCompat extends ActionBarSherlock implements MenuBuilder.Callback, com.actionbarsherlock.view.Window.Callback, MenuPresenter.Callback, android.view.MenuItem.OnMenuItemClickListener {
    ...
    public ActionMode startActionMode(ActionMode.Callback callback) {
        ...
        if (mode != null) {
            ...
            if (mActionModeView == null) {
                ViewStub stub = mDecor.findViewById(R.id.abs__action_mode_bar_stub);
                if (stub != null) {
    ...
    private IcsProgressBar getCircularProgressBar(boolean shouldInstallDecor) {
        ...
        mCircularProgressBar = mDecor.findViewById(R.id.abs__progress_circular);
        if (mCircularProgressBar != null) {
    ...
    private IcsProgressBar getHorizontalProgressBar(boolean shouldInstallDecor) {
        ...
        mHorizontalProgressBar = mDecor.findViewById(R.id.abs__progress_horizontal);
        if (mHorizontalProgressBar != null) {
    ...
    private void installDecor() {
        ...
        if (mDecor == null) {
            mDecor = mActivity.getWindow().getDecorView().findViewById(android.R.id.content);
        }
        if (mContentParent == null) {
            ...
            wActionBar = mDecor.findViewById(R.id.abs__action_bar);
            if (wActionBar != null) {
                ...
                final ActionBarContainer splitView = mDecor.findViewById(R.id.abs__split_action_bar);
                if (splitView != null) {
                    ...
                    mActionModeView = mDecor.findViewById(R.id.abs__action_context_bar);
    ...
    private ViewGroup generateLayout() {
        ...
        ViewGroup contentParent = mDecor.findViewById(R.id.abs__content);
